...
func TestPrevMatching(t *testing.T) {
	...
	for _, c := range runs {
		...
		// generate sequence of cron jobs in future
		timeProbe := make([]probe, 0, probeCount)

		baseTime := getTime(c.time)
		now := getTime(c.time)
		for i := 0; i < probeCount; i++ {
			...
			if now.Year()-baseTime.Year() > 10 {
				break
			}
		}

		// iterate backward and match every scheduled time
		for i := len(timeProbe) - 1; i >= 1; i-- {
...
func TestPrev(t *testing.T) {
	runs := []struct {
		...
		{"Mon Dec 9 23:35 2012", "0 0 0 */5 Oct Mon", "Mon Oct 31 00:00 2012"},
		...
		// Daylight savings time 2am EST (-5) -> 3am EDT (-4)
		{"2013-03-11T03:30:00-0400", "TZ=America/New_York 0 30 2 11 Mar ?", "2013-03-11T02:30:00-0400"},
		{"2012-03-11T03:30:00-0400", "TZ=America/New_York 0 30 2 11 Mar ?", "2011-03-11T02:30:00-0500"},

		// hourly job
		{"2012-03-11T00:00:00-0500", "TZ=America/New_York 0 0 * * * ?", "2012-03-10T23:00:00-0500"},
		{"2012-03-11T01:00:00-0500", "TZ=America/New_York 0 0 * * * ?", "2012-03-11T01:00:00-0400"},
		{"2012-03-11T03:00:00-0400", "TZ=America/New_York 0 0 * * * ?", "2012-03-11T02:00:00-0400"},
		{"2012-03-11T04:00:00-0400", "TZ=America/New_York 0 0 * * * ?", "2012-03-11T03:00:00-0400"},

		{"2013-03-11T00:01:00-0500", "TZ=America/New_York 0 0 * * * ?", "2013-03-11T01:00:00-0400"},
		{"2013-03-11T01:01:00-0500", "TZ=America/New_York 0 0 * * * ?", "2013-03-11T02:00:00-0400"},
		{"2013-03-11T03:01:00-0400", "TZ=America/New_York 0 0 * * * ?", "2013-03-11T03:00:00-0400"},
		{"2013-03-11T04:01:00-0400", "TZ=America/New_York 0 0 * * * ?", "2013-03-11T04:00:00-0400"},

		// hourly job using CRON_TZ
		{"2012-03-11T00:00:00-0500", "CRON_TZ=America/New_York 0 0 * * * ?", "2012-03-10T23:00:00-0500"},
		{"2012-03-11T01:00:00-0500", "CRON_TZ=America/New_York 0 0 * * * ?", "2012-03-11T00:00:00-0500"},
		{"2012-03-11T03:00:00-0400", "CRON_TZ=America/New_York 0 0 * * * ?", "2012-03-11T02:00:00-0400"},
		...
		// 2am nightly job (skipped)
		{"2012-03-12T02:00:00-0400", "TZ=America/New_York 0 0 2 * * ?", "2012-03-10T02:00:00-0500"},

		// Daylight savings time 2am EDT (-4) => 1am EST (-5)
		{"2012-11-05T02:30:00-0500", "TZ=America/New_York 0 30 2 04 Nov ?", "2012-11-04T02:30:00-0500"},
		{"2012-11-05T01:30:00-0500", "TZ=America/New_York 0 30 1 04 Nov ?", "2012-11-04T01:30:00-0500"},
		...
		{"TZ=America/New_York 2012-11-05T01:00:00-0500", "0 0 1 * * ?", "2012-11-04T01:00:00-0500"},

		// 2am nightly job
		{"TZ=America/New_York 2012-11-04T02:00:00-0500", "0 0 2 * * ?", "2012-11-03T02:00:00-0400"},
		{"TZ=America/New_York 2012-11-05T02:00:00-0500", "0 0 2 * * ?", "2012-11-04T02:00:00-0500"},
		...
		// Monthly job
		{"TZ=America/New_York 2012-11-04T00:00:00-0400", "0 0 3 3 * ?", "2012-11-03T03:00:00-0400"},

		// Test the scenario of DST resulting in midnight not being a valid time.
		// https://github.com/robfig/cron/issues/157
		{"2018-10-17T05:00:00-0400", "TZ=America/Sao_Paulo 0 0 9 10 * ?", "2018-10-10T08:00:00-0400"},
		{"2018-02-14T05:00:00-0500", "TZ=America/Sao_Paulo 0 0 9 22 * ?", "2018-01-22T06:00:00-0500"},
		{"2018-11-10T06:00:00-0500", "TZ=America/Sao_Paulo 0 0 9 10 * ?", "2018-10-10T07:00:00-0500"},
		{"2018-02-22T07:00:00-0500", "TZ=America/Sao_Paulo 0 0 9 22 * ?", "2018-01-22T06:00:00-0500"},
	}
